  ...
  <section class="seccion contenedor">
    ...
    <form id="registro" class="registro" action="pagar.php" method="post">
        ...
        <div id="eventos" class="eventos clearfix">
            ...
            <div class="caja">
                  <div id="viernes" class="contenido_dia clearfix">
                      <h4>Viernes</h4>
                          <div>
                              <p>Talleres:</p>
                  ...
                  <div id="sabado" class="contenido_dia clearfix">
                      <h4>Sábado</h4>
                      <div>
                            <p>Talleres:</p>
                  ...
                  <div id="domingo" class="contenido_dia clearfix">
                      <h4>Domingo</h4>
                      <div>
                            <p>Talleres:</p>
            ...
            <div class="caja clearfix">
                <div class="extras">
                    ...
                    <div class="orden">
                        ...
                        <input type="number" min="0" id="etiquetas" size="3" name="pedido_extra[etiquetas]" placeholder="0">
